...
const Room = () => {
    ...
    const handleLikeQuestion = async (idQuestion: string, likeId: string | undefined) => {
        if (likeId) {
            await database.ref(`rooms/${idRoom}/questions/${idQuestion}/likes/${likeId}`).remove();
        } else {
            await database.ref(`rooms/${idRoom}/questions/${idQuestion}/likes`).push({
                authorId: user?.id,
            });
        }
    }
                ...
                <form onSubmit={handleSendQuestion}>
                    ...
                    <div className="form-footer">
                        {user ? (
                            ...
                            <span>To submit a question, <button>do your sign in</button>. </span>
                        )}
